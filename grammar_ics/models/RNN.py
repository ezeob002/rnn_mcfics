...
# TODO: Move this to a different ofolder, it should be different from the model
...
class Optimization:
    ...
    def train(self, train_set, val_set, n_epochs=50, early_stop=False, exp_name='exp',
              save_interval=0, verbose=True, save=True, load=True, project_dir='trained_rnns',res_dir='trained_rnns'):

        self.model.get_model_name(exp_name)
        model_path = f'{project_dir}/{self.model.model_name}.pt'
        ...
        if save:
            ...
            performance_path = f'{res_dir}/result.txt'
